  ...
  var Datetimepicker = function(element, options) {
    ...
    if (this.isRTL){
      ...
      this.picker.find('.prev i, .next i')
        ...
        //tdh
        .toggleClass('glyphicon-arrow-left glyphicon-arrow-right icon-arrow-left icon-arrow-right');
    }
  ...
  var DPGlobal = {
    ...
    nonpunctuation: /[^ -\/:-@\[-`{-~\t\n\rTZ]+/g,
                       ...
                       headTemplate: '<thead>'+
                         ...
                         '<th class="prev"><i class="glyphicon glyphicon-arrow-left icon-arrow-left"/></th>'+
                         '<th colspan="5" class="switch"></th>'+
                         //tdh
                         //'<th class="prev"><i class="icon-arrow-right"/></th>'+
                         '<th class="next"><i class="glyphicon glyphicon-arrow-right icon-arrow-right"/></th>'+
                         '</tr>'+
                         '</thead>',
